...
public class TierFiveConfig implements ConfigData, TierConfig {
    ...
    @Comment("Raid boss HP multiplier. Default: 20")
    ...
    @Comment("Reward Pokemon number of max IVs. Default: 4")
    public int ivs = 4;
    ...
    @Comment("How much currency is rewarded for clearing a raid boss (Requires CobbleDollars). Default: 20000")
    ...
    @Comment("Cooperative raid boss HP multiplier (boss HP = normal HP * multiplier). Default: 10")
    public int coop_health_multiplier = 10;
