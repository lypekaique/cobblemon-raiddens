...
@Config(name="cobblemonraiddens/tier_seven")
public class TierSevenConfig implements ConfigData, TierConfig {
    ...
    @Comment("Raid boss level. Default: 100")
    public int boss_level = 100;
    @Comment("Reward Pokemon level. Default: 100")
    public int reward_level = 100;
    @Comment("Reward Pokemon number of max IVs. Default: 6")
    public int ivs = 6;
    ...
    @Comment("How much currency is rewarded for clearing a raid boss (Requires CobbleDollars). Default: 100000")
    ...
    @Comment("Cooperative raid boss HP multiplier (boss HP = normal HP * multiplier). Default: 15")
    public int coop_health_multiplier = 15;
