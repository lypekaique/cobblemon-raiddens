...
public class TierThreeConfig implements ConfigData, TierConfig {
    ...
    @Comment("Raid boss level. Default: 35")
    public int boss_level = 35;
    @Comment("Reward Pokemon level. Default: 35")
    public int reward_level = 35;
    ...
    @Comment("Cooperative raid boss HP multiplier (boss HP = normal HP * multiplier). Default: 6")
    public int coop_health_multiplier = 6;
