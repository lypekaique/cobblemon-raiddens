...
public class TierOneConfig implements ConfigData, TierConfig {
    ...
    @Comment("Raid boss level. Default: 12")
    public int boss_level = 12;
    @Comment("Reward Pokemon level. Default: 12")
    ...
    @Comment("Cooperative raid boss HP multiplier (boss HP = normal HP * multiplier). Default: 4")
    public int coop_health_multiplier = 4;
