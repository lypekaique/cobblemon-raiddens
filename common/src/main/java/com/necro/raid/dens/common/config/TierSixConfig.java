...
@Config(name="cobblemonraiddens/tier_six")
public class TierSixConfig implements ConfigData, TierConfig {
    ...
    @Comment("How much currency is rewarded for clearing a raid boss (Requires CobbleDollars). Default: 50000")
